...
from diag.PySipebiDiagAturanTandaBacaPadaDialog import PySipebiDiagAturanTandaBacaPadaDialog
...
class PySipebiDiagAturanTandaBacaPadaDialog_Val(PySipebiMiniValidationBase):
    ...
    diagScriptFileName = 'PySipebiDiagAturanTandaBacaPadaDialog.py'
    sipebiErrorCodes = ['[TB07]', '[TB08]']

    # Shared resources and output-related properties
    hasSharedResources = True
    # file resources that are taken from py\data\ folder
    fileResourceNames = \
        ['PySipebiDiagAturanTandaBacaPadaDialog_common_check.txt',
        'PySipebiDiagAturanTandaBacaPadaDialog_test.txt']
    # the output file name of this validation script
    outputFilename = 'PySipebiDiagAturanTandaBacaPadaDialog_result.txt'
    ...
    def execute_with_shared_resources(self, shared_resources):
        ...
        try:
            ...
            diag_script = PySipebiDiagAturanTandaBacaPadaDialog()
            # TODO read test input file here and execute the diagnostics script using the test input file [PySipebiDiagExample_test.txt]
            test_file = shared_resources.get('PySipebiDiagAturanTandaBacaPadaDialog_test.txt')
...
if __name__ == "__main__":
    validation_runner = PySipebiCommonValidationRunner(PySipebiDiagAturanTandaBacaPadaDialog_Val)
