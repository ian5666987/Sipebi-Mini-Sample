...
class PySampleClass(PySipebiAnalyzerBase):
	...
	diagList = [] #daftar kesalahan. List ini harus ada (hanya contoh, sudah terdefinisikan pada PySipebiAnalyzerBase)
	isReady = False #bendera yang menandakan pengaturan awal sudah selesai dikerjakan. Bendera ini harus ada (hanya contoh, sudah terdefinisikan pada PySipebiAnalyzerBase)
	#setup: fungsi untuk melakukan pengaturan awal sebelum 'execute' dijalankan. Fungsi ini harus ada (hanya contoh, sudah terdefinisikan pada PySipebiAnalyzerBase)
	...
	#execute: fungsi untuk menjalankan penyuntingan. Fungsi ini harus ada (hanya contoh, sudah terdefinisikan pada PySipebiAnalyzerBase)
